...
G_squared
```
A $G^{2}$ value of 12.59 means for 12 categories (i.e., 11 degrees of freedom under the null hypothesis), it is smaller than the critical value at the 5% level (approximately 19.68). 
