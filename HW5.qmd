...
names(heatmap_data) <- c("Fresh_Frozen_Cluster", "All_Variables_Cluster", "Count")

# Create heatmap
ggplot(heatmap_data, aes(x = Fresh_Frozen_Cluster, y = All_Variables_Cluster, fill = Count)) +
  geom_tile() +
