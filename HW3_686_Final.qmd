...
$N = n_{11} + n_{12} + n_{21} + n_{22} = 9,510$ (Total sample size)

Step 1: Calculate the Risk Ratio (RR)
In a prospective study, I calculated the risk ratio directly from incidence proportions as:
...
Step 2: Then to calculate the Attributable Risk for Exposed
$AR_{exposed} = \frac{RR - 1}{RR} = \frac{1.400 - 1}{1.400} = 0.286$ or 28.6%
...
$p_1 = n_{11}/(n_{11}+n_{12}) = 127/1,351 = 0.094$ (risk in exposed)
$p_0 = n_{21}/(n_{21}+n_{22}) = 548/8,159 = 0.067$ (risk in unexposed)
$n_1 = n_{11}+n_{12} = 1,351$ (total exposed)
$n_0 = n_{21}+n_{22} = 8,159$ (total unexposed)
$Var[ln(1-PAR)] = \frac{1-0.0537}{0.0537} \times [\frac{1-0.094}{1,351 \times 0.094} + \frac{1-0.067}{8,159 \times 0.067}]$
...
$95% CI = 1 - exp[ln(1-PAR) \pm 1.96 \times \sqrt{Var[ln(1-PAR)]}]$
