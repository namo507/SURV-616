...
# Calculating and plot Pearson residuals
...
set.seed(123)
folds <- CreatingFolds(chd_data$chd, k = 10)
...
# Let's reCreating it for demonstration
chd_data <- read.csv("chd.csv")
chd_data$famhist <- as.factor(chd_data$famhist)
...
var_importance <- lapply(names(final_model$coefficients)[-1], function(var) {
  # Creating a formula without this variable
...
# Creating contour plot of probability surface
