...
1) First, calculating the odds ratio:

Odds (voucher) = $\frac{166}{564} = 0.294$
Odds (donation) = $\frac{121}{609} = 0.199$

Odds Ratio = $\frac{0.294}{0.199} = \frac{166 \times 609}{564 \times 121} = 1.48$

2) For the deviance (G2), I'll use:
$G^2 = 2\sum_{i} O_i \ln(\frac{O_i}{E_i})$

Where:
$O_i$ = Observed frequencies: [166, 564, 121, 609]
$E_i$ = Expected frequencies under independence

$G^2 = 2[(166\ln\frac{166}{143.5}) + (564\ln\frac{564}{586.5}) + (121\ln\frac{121}{143.5}) + (609\ln\frac{609}{586.5})] = 8.81$
...
Now the odds of responding to a voucher incentive are approximately 1.48 times higher than the odds of responding to a donation incentive, which suggests vouchers may be more effective.

The deviance statistic of 8.81 (compared to a $X^{2}$ critical value of 3.84 at alpha=0.05) indicates that there is statistically significant association between incentive type and response rate. Thus, vouchers likely improve response rates compared to donations.
